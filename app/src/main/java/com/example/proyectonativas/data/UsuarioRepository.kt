package com.example.proyectonativas.data
...
object UsuarioRepository {
    ...
    suspend fun existeUsuario(userId: String): Boolean {
        return try{
            val resultado = SupabaseCliente.cliente
                .postgrest["usuarios"]
    ...
    suspend fun obtenerUsuarioActual(): UsuarioData? {
        val userId = SupabaseCliente.cliente.auth
    ...
    suspend fun actualizarPerfil(
        ...
        SupabaseCliente.cliente.postgrest["usuarios"]
            .update(datos) {
                filter { eq("id", userId) }
            }
    }
    ...
    suspend fun subirFotoPerfil(
        ...
        SupabaseCliente.cliente.storage["avatar"]
            .upload(
                path = rutaArchivo,
                data = bytes,
                options = { upsert = true }
        ...
        val url = SupabaseCliente.cliente.storage["avatar"]
